...
public class PlayerTurn : MonoBehaviour
{
    ...
    public void Fire()
    {
        ...
        if(tile != null)// && (tile.getStatus() == Status.EMPTY) || (tile.getStatus() == Status.SHIP))
        {
            if ((tile.getStatus() == Status.EMPTY) || (tile.getStatus() == Status.SHIP))
            {
                tile.Fire(tile);
                ...
                gameManager.didPlayerFire = true;
            }
            else
            {
                gameManager.didPlayerFire = false;
            }
        }
        else
        {
